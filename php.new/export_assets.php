...
try {
    ...
    $heads  = array("Name", "Label", "Location", "Rack", "Serial Number", "Asset Tag", "Manufacturer", "Model", "Elevation", "Num RUs", "Business Service", "Subsystem");
    $fields = array("name", "label", "location", "cabinet", "serialNumber", "assetTag", "manufacturer", "model", "elevation", "numRUs", "businessService", "subsystem");
    ...
    $excelFileName = "ACDC_Assets_Export_{$dateStamp}.xlsx";
