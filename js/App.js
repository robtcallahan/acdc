...
ACDC.App = Ext.extend(Ext.Viewport, {
    ...
    initComponent: function ()
    {
        ...
        this.footer = {
            ...
            html:    [
                         ...
                         "Powered by -- <a href='http://www.sencha.com/'>ExtJS</a>, <a href='http://fabricjs.com/>Fabric.js</a>' &amp; <a href='http://us2.php.net/'>PHP</a>",
                         "</div>"
                     ].join("")
        ...
        this.reportsGrid = new ACDC.ReportsGrid({
            title:  'Reports',
            id:     'reports-tab',
            height: 180,
            actor:  this.actor,
        ...
        this.locationsStore.load({
            callback: function() {
                var i, name, id, me = this;

                var menuItemsNeustar = Ext.getCmp('menu-location-neustar').menu,
                    menuItemsDomestic = Ext.getCmp('menu-location-domestic').menu,
                    menuItemsAbroad = Ext.getCmp('menu-location-abroad').menu,

                    menuItemsGridNeustar = Ext.getCmp('menu-grid-location-neustar').menu,
                    menuItemsGridDomestic = Ext.getCmp('menu-grid-location-domestic').menu,
                    menuItemsGridAbroad = Ext.getCmp('menu-grid-location-abroad').menu,

                    locations = this.locationsStore.data.items;

                for (i = 0; i < locations.length; i++) {
                    name = locations[i].data.name;
                    id = locations[i].data.id;
                    if (name.search(/Sterling|Charlotte|Denver/) !== -1) {
                        menuItemsNeustar.addMenuItem({
                            text:    name,
                            scope:   me,
                            locationId: id,
                            handler: function(item, e) {
                                me.dcLayoutPanel.locationSelected(item.locationId);
                            }
                        });
                        menuItemsGridNeustar.addMenuItem({
                            xtype:   'menucheckitem',
                            group: 'grid-location-selector',
                            text:    name,
                            scope:   me,
                            locationId: id,
                            checked:  parseInt(id) === 1,
                            handler: function(item, e) {
                                me.assetsGridPanel.locationSelected(me.locationsHash[item.locationId]);
                            }
                        });
                    } else if (name.search(/^[\w\s]+-[A-Z][A-Z]-/) !== -1) {
                        menuItemsDomestic.addMenuItem({
                            text:    name,
                            scope:   me,
                            locationId: id,
                            handler: function(item, e) {
                        ...
                        menuItemsGridDomestic.addMenuItem({
                            xtype:   'menucheckitem',
                            group: 'grid-location-selector',
                            text:    name,
                            scope:   me,
                        ...
                        menuItemsGridAbroad.addMenuItem({
                            xtype:   'menucheckitem',
                            group: 'grid-location-selector',
                            text:    name,
                            scope:   me,
                    ...
                    me.locationsHash[id] = locations[i].data;
                }
                me.dcLayoutPanel.addTitle();
                Ext.getCmp('location-group').setText(me.locationsHash[1].name);
            },
            scope: this
            }
        );
                        ...
                        items: [
                            {
                                ...
                                menu: {
                                    ...
                                    items: [
                                        ...
                                        {
                                            text: 'Co-Lo',
                                            id: 'menu-location-colo',
                                            menu: {
                                                xtype: 'menu',
                                                items: [
                                                    {
                                                        text: 'Domestic',
                                                        id: 'menu-location-domestic',
                                                        menu: {
                                                            xtype: 'menu',
                                                            items: []
                                                        }
                            ...
                            },
                            {
                                ...
                                menu: {
                                    ...
                                    items: [
                                        {
                                            text: 'Available Tile Marker',
                                            id: 'menu-add-placeholder',
                                            scope: this.dcLayoutPanel,
                                            handler: this.dcLayoutPanel.newPlaceholder
                                        },
                                        {
                                            text: 'Cabinet',
                                            id: 'menu-add-cabinet',
                                                ...
                                                items: [
                                                    {
                                                        ...
                                                        scope:   this,
                                                        handler: function () {
                                                            this.dcLayoutPanel.newCabinet(1);
                                                        }
                                                    },
                                                    {
                                                        ...
                                                        scope:   this,
                                                        handler: function () {
                                                            this.dcLayoutPanel.newCabinet(3);
                                                        }
                                                    },
                                                    {
                                                        ...
                                                        scope:   this,
                                                        handler: function () {
                                                            this.dcLayoutPanel.newCabinet(2);
                                                        }
                                                    },
                                                    {
                                                        ...
                                                        scope:   this,
                                                        handler: function () {
                                                            this.dcLayoutPanel.newCabinet(8);
                                                        }
                                                    },
                                                    {
                                                        ...
                                                        scope:   this,
                                                        handler: function () {
                                                            this.dcLayoutPanel.newCabinet(4);
                                                        }
                                                    },
                                                    {
                                                        ...
                                                        scope:   this,
                                                        handler: function () {
                                                            this.dcLayoutPanel.newCabinet(12);
                                                        }
                                                    },
                                                    {
                                                        text:    'EMC VNX 24"x36"',
                                                        scope:   this,
                                                        handler: function () {
                                                            this.dcLayoutPanel.newCabinet(13);
                                                        }
                                                    },
                                                    {
                                                        text:    'EMC 24"x38"',
                                                        scope:   this,
                                                        handler: function () {
                                                            this.dcLayoutPanel.newCabinet(5);
                                                        }
                                                    },
                                                    {
                                                        text:    'Great Lakes 24"x48"',
                                                        scope:   this,
                                                        handler: function () {
                                                            this.dcLayoutPanel.newCabinet(18);
                                                        }
                                                    },
                                                    {
                                                        text:    'Netezza 24"x38"',
                                                        scope:   this,
                                                        handler: function () {
                                                            this.dcLayoutPanel.newCabinet(11);
                                                        }
                                                    },
                                                    {
                                                        text:    'Quest 30"x36"',
                                                        scope:   this,
                                                        handler: function () {
                                                            this.dcLayoutPanel.newCabinet(9);
                                                        }
                                                    },
                                                    {
                                                        text:    'Quantum 24"x36"',
                                                        scope:   this,
                                                        handler: function () {
                                                            this.dcLayoutPanel.newCabinet(7);
                                                        }
                                                    },
                                                    {
                                                        text:    'Verint 24"x37"',
                                                        scope:   this,
                                                        handler: function () {
                                                            this.dcLayoutPanel.newCabinet(10);
                                                        }
                                                    },
                                                    {
                                                        text:    'Battery 48"x34"',
                                                        scope:   this,
                                                        handler: function () {
                                                            this.dcLayoutPanel.newCabinet(6);
                                                        }
                                                    }
                                                ]
                                            }
                                                ...
                                                items: [
                                                    {
                                                        ...
                                                        scope: this,
                                                        handler: function () {
                                                            this.dcLayoutPanel.newColumn(21);
                                                        }
                                                    }, {
                                                        text: '24"x48"',
                                                        scope: this,
                                                        handler: function () {
                                                            this.dcLayoutPanel.newColumn(20);
                                                        }
                                                    }
                                                ]
                                            }
                                        },
                                        {
                                            ...
                                            id: 'menu-add-crac',
                                            scope: this.dcLayoutPanel,
                                            handler: this.dcLayoutPanel.newCrac
                                        },
                                        {
                                            text: 'Line',
                                            id: 'menu-add-line',
                                            scope: this.dcLayoutPanel,
                                            handler: this.dcLayoutPanel.newLine
                                        },
                                        {
                                            text: 'PDU',
                                            id: 'menu-add-pdu',
                                            scope: this.dcLayoutPanel,
                                            handler: this.dcLayoutPanel.newPdu
                                        },
                                        {
                                            text: 'Perferated Tile',
                                            id: 'menu-add-perf-tile',
                                            scope: this.dcLayoutPanel,
                                            handler: this.dcLayoutPanel.newPerfTile
                                        },
                                        {
                                            text: 'Text',
                                            id: 'menu-add-text',
                                            scope: this.dcLayoutPanel,
                                            handler: this.dcLayoutPanel.newText
                                        },
                                        {
                                            text: 'Generic Item',
                                            id: 'menu-add-generic',
                                            scope: this.dcLayoutPanel,
                                            handler: this.dcLayoutPanel.newGeneric
                                        }
                                    ]
                                }
                            },
                            ...
                            },
                            {
                                ...
                                handler: function () {
                                    ...
                                    if (activeTabId === 'list-tab') {
                                        this.assetsGridPanel.exportGrid();
                                    } else if (activeTabId === 'exceptions-container') {
                                        this.exceptionsGridPanel.exportGrid();
                                    }
                                }
                            }
                        ]
                ...
                },
                {
                    ...
                    menu: {
                        ...
                        items: [
                            ...
                            {
                                text: 'Co-Lo',
                                id: 'menu-grid-location-colo',
                                menu: {
                                    xtype: 'menu',
                                    items: [
                                        {
                                            text: 'Domestic',
                                            id: 'menu-grid-location-domestic',
                                            menu: {
                                                xtype: 'menu',
                                                items: []
                                            }
                            ...
                            {
                                text: 'All Locations',
                                id: 'menu-grid-location-all',
                                scope: this,
                                handler: function() {
                                    // set location id to 0 to indicate all
                                    var location = {
                                        id: 0,
                                        name: 'All Locations'
                                    };
                                    this.assetsGridPanel.locationSelected(location);
                                }
                            }
                        ]
                    }
                 ...
                 listeners: {
                    ...
                    tabchange: function(tabPanel, tab) {
                        ...
                        if (tabPanel.activeTab.id !== 'layout-tab') {
                            ...
                            else if (tabPanel.activeTab.id === 'exceptions-container' && me.exceptionsGridPanel.store.getCount() === 0) {
                            ...
                            else if (tabPanel.activeTab.id === "reports-tab") {
                                tabPanel.activeTab.getStore().load();
                            }
    ...
    switchTab: function(panel, tabIndex, data) {
        Ext.getCmp('tabpanel').setActiveTab(tabIndex);
        this.assetsGridPanel.showAsset(data);
    },
        ...
        if (typeof this.newLocationWindow === "undefined" || this.newLocationWindow === null) {
            ...
            form = new Ext.form.FormPanel({
                ...
                buttons:      [
                    {
                        text:     'Create',
                        id:       'button-create-location',
                        formBind: true,
                        scope:    this,
                        handler:  function ()
                        {
                            if (Ext.getCmp('cmdb-locations-combo').getValue()) {
                                Ext.Ajax.request(
                                    {
                                        ...
                                        mycallback: function (json) {
                                            this.dcLayoutPanel.locationSelected(json.id);
                                        }
                                    });
    ...
    gridSearch: function(textField, e) {
        var searchString = Ext.getCmp('grid-search').getValue(),
            ...
            re,
            cb,
            stateValues = ["Installed", "In Transit", "Inventory", "Decommed", "Awaiting Disposal", "Disposed"],
            stateChecked = [];
    ...
    toggleMenuOptions: function(tabId) {
        var layoutMenuItems = ['menu-location', 'menu-install', 'menu-print', 'menu-edit', 'menu-add', 'menu-options'],
            gridMenuItems = ['menu-export'],
            layoutShowItems = ['layout-search', 'layout-searchBS', 'show-capacity-button', 'show-exceptions-button'],
            gridShowItems = ['bulk-edit-button', 'grid-search', 'location-group-label', 'location-group', 'state-group-label', 'state-Installed', 'state-In Transit', 'state-Inventory', 'state-Decommed', 'state-Awaiting Disposal', 'state-Disposed'],
            i;
    ...
    installAsset: function() {
        this.prepareForAdd();
        this.assetDetails.installAsset(this.locationsHash[this.dcLayoutPanel.currentLocationId].name);
    },
    ...
    cancelAssetEdit: function () {
        ...
        if (this.locationChange) {
            ...
            this.dcLayoutPanel.locationChange();
